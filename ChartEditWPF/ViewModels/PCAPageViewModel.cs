...
{
    internal partial class PCAPageVM(IFileDialog _fileDialog, IMessageBox _messageBox, IInputForm _selectDialog, ILogger<PCAPageVM> _logger) : SamplePageViewModel(_fileDialog, _messageBox, _selectDialog, _logger)
    {
